...
export const en: TranslationKeys = {
  ...
  validation: {
    ...
    loginIdentifierInvalid: "Enter a valid username or email address.",
  ...
  admin: {
    ...
    legacyEmailLogin: "Legacy account can still log in with this email",
    save: "Save",
    cancel: "Cancel",
    delete: "Delete",
    ...
    price: "Price",
    date: "Date",
    searchPlaceholder: "Search members (username)...",
