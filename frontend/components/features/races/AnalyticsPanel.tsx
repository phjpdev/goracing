  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
      <article className="rounded-xl sm:rounded-2xl border border-white/10 bg-[#1a1a1a] p-4 sm:p-5 lg:p-6">
        ...
        <div className="flex items-center justify-center min-h-[160px] sm:min-h-[240px] mx-auto">
          <Image src="/assets/Pedigree-Analysis.png" alt="Pedigree Analysis" width={300} height={300} className="w-full max-w-[200px] sm:max-w-[240px] h-auto object-contain" />
        </div>
      </article>
      ...
      <article className="rounded-xl sm:rounded-2xl border border-white/10 bg-[#1a1a1a] p-4 sm:p-5 lg:p-6">
        ...
        <div className="flex items-center justify-center min-h-[160px] sm:min-h-[240px] mx-auto">
          <Image src="/assets/Win-Probability.png" alt="AI Win Probability" width={300} height={300} className="w-full max-w-[200px] sm:max-w-[240px] h-auto object-contain" />
        </div>
      </article>
      ...
      <article className="rounded-xl sm:rounded-2xl border border-white/10 bg-[#1a1a1a] p-4 sm:p-5 lg:p-6 md:col-span-2 lg:col-span-1">
        ...
        <div className="flex flex-col items-center justify-center min-h-[200px] sm:min-h-[240px]">
          <Image src="/assets/Market-Activity.png" alt="Market Activity" width={380} height={300} className="w-full max-w-[280px] sm:max-w-[320px] h-auto object-contain" />
